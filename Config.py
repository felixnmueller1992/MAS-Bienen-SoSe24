...
FOOD_COUNT = 100 #Anzahl Futterquellen im System
...
#Paramter Biene
MAX_VELOCITY_BEE = 100 #Maximale Geschwindigkeit einer Biene
MIN_VELOCITY_BEE = 80 #Minimale Geschwindigkeit einer Biene
